...
namespace ZeroMQ.Interop
{
    ...
    internal static class LibZmq
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int ZmqBufferRecvProc(IntPtr socket, IntPtr buff, int size, int flags);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int ZmqBufferSendProc(IntPtr socket, IntPtr buff, int size, int flags);
